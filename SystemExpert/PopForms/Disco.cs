...
namespace SystemExpert.PopForms
{
    public partial class Disco : Form
    {
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            {
                FileName = "https://ru.wikipedia.org/wiki/%D0%95%D0%B2%D1%80%D0%BE%D0%B4%D1%8D%D0%BD%D1%81",
        ...
        private void linkLabel2_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start(new ProcessStartInfo
            {
                FileName = "https://en.wikipedia.org/wiki/French_house#Terms,_origins_and_variations",
                UseShellExecute = true
            });
        }
        ...
        private void linkLabel3_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start(new ProcessStartInfo
            {
                FileName = "https://ru.wikipedia.org/wiki/%D0%A5%D0%B0%D0%B9-%D1%8D%D0%BD%D0%B5%D1%80%D0%B4%D0%B6%D0%B8",
                UseShellExecute = true
            });
        }
        ...
        private void linkLabel4_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start(new ProcessStartInfo
            {
                FileName = "https://ru.wikipedia.org/wiki/%D0%98%D1%82%D0%B0%D0%BB%D0%BE-%D0%B4%D0%B8%D1%81%D0%BA%D0%BE",
                UseShellExecute = true
            });
        }
        ...
        private void linkLabel5_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start(new ProcessStartInfo
            {
                FileName = "https://ru.wikipedia.org/wiki/%D0%9D%D1%8E-%D0%B4%D0%B8%D1%81%D0%BA%D0%BE",
                UseShellExecute = true
            });
        }
    }
