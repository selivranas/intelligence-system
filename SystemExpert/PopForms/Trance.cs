...
namespace SystemExpert.PopForms
{
    public partial class Trance : Form
    {
        ...
        public Trance(MainForm t_mainform)
        {
            InitializeComponent();
            mainform = t_mainform;
            GenreService.SetCurrentGenre(Enums.GenresTypeEnum.Транс);
        ...
        private void Trance_FormClosed(object sender, FormClosedEventArgs e)
        {
            mainform.Show();
        }
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            {
                FileName = "https://ru.wikipedia.org/wiki/%D0%9F%D1%80%D0%BE%D0%B3%D1%80%D0%B5%D1%81%D1%81%D0%B8%D0%B2%D0%BD%D1%8B%D0%B9_%D1%82%D1%80%D0%B0%D0%BD%D1%81",
        ...
        private void linkLabel2_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start(new ProcessStartInfo
            {
                FileName = "https://ru.wikipedia.org/wiki/%D0%93%D0%BE%D0%B0-%D1%82%D1%80%D0%B0%D0%BD%D1%81",
                UseShellExecute = true
            });
        }
        ...
        private void linkLabel3_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start(new ProcessStartInfo
            {
                FileName = "https://ru.wikipedia.org/wiki/%D0%A5%D0%B0%D1%80%D0%B4-%D1%82%D1%80%D0%B0%D0%BD%D1%81",
                UseShellExecute = true
            });
        }
        ...
        private void linkLabel4_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start(new ProcessStartInfo
            {
                FileName = "https://ru.wikipedia.org/wiki/%D0%AD%D0%B9%D1%81%D0%B8%D0%B4-%D1%82%D1%80%D0%B0%D0%BD%D1%81",
                UseShellExecute = true
            });
        }
        ...
        private void linkLabel5_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start(new ProcessStartInfo
            {
                FileName = "https://ru.wikipedia.org/wiki/%D0%95%D0%B2%D1%80%D0%BE%D1%82%D1%80%D0%B0%D0%BD%D1%81",
                UseShellExecute = true
            });
        }
    }
