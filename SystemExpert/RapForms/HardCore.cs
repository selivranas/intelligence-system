...
namespace SystemExpert.RapForms
{
    public partial class HardCore : Form
    {
        ...
        public HardCore(MainForm t_mainform)
        {
            InitializeComponent();
            mainform = t_mainform;
            GenreService.SetCurrentGenre(Enums.GenresTypeEnum.Хардкор);
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            {
                FileName = "https://ru.wikipedia.org/wiki/%D0%9C%D0%B5%D0%BC%D1%84%D0%B8%D1%81-%D1%80%D1%8D%D0%BF",
        ...
        private void linkLabel2_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start(new ProcessStartInfo
            {
                FileName = "https://dj.ru/musicstyle/dirty-rap",
                UseShellExecute = true
            });
        }
        ...
        private void linkLabel3_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start(new ProcessStartInfo
            {
                FileName = "https://ru.wikipedia.org/wiki/%D0%A5%D0%BE%D1%80%D1%80%D0%BE%D1%80%D0%BA%D0%BE%D1%80",
                UseShellExecute = true
            });
        }
        ...
        private void linkLabel4_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start(new ProcessStartInfo
            {
                FileName = "https://ru.wikipedia.org/wiki/%D0%93%D0%B0%D0%BD%D0%B3%D1%81%D1%82%D0%B0-%D1%80%D1%8D%D0%BF",
                UseShellExecute = true
            });
        }
    }
