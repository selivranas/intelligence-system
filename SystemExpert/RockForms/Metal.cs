...
namespace SystemExpert
{
    public partial class Metal : Form
    {
        ...
        public Metal(MainForm t_mainform)
        {
            InitializeComponent();
            mainform = t_mainform;
            GenreService.SetCurrentGenre(Enums.GenresTypeEnum.Метал);
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            {
                FileName = "https://ru.wikipedia.org/wiki/%D0%93%D0%BB%D1%8D%D0%BC-%D0%BC%D0%B5%D1%82%D0%B0%D0%BB",
        ...
        private void linkLabel2_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start(new ProcessStartInfo
            {
                FileName = "https://ru.wikipedia.org/wiki/%D0%98%D0%BD%D0%B4%D0%B0%D1%81%D1%82%D1%80%D0%B8%D0%B0%D0%BB-%D0%BC%D0%B5%D1%82%D0%B0%D0%BB",
                UseShellExecute = true
            });
        }
        ...
        private void linkLabel3_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start(new ProcessStartInfo
            {
                FileName = "https://ru.wikipedia.org/wiki/%D0%9D%D1%8E-%D0%BC%D0%B5%D1%82%D0%B0%D0%BB",
                UseShellExecute = true
            });
        }
        ...
        private void linkLabel4_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start(new ProcessStartInfo
            {
                FileName = "https://ru.wikipedia.org/wiki/%D0%A4%D0%BE%D0%BB%D0%BA-%D0%BC%D0%B5%D1%82%D0%B0%D0%BB",
                UseShellExecute = true
            });
        }
        ...
        private void linkLabel5_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start(new ProcessStartInfo
            {
                FileName = "https://ru.wikipedia.org/wiki/%D0%91%D0%BB%D1%8D%D0%BA-%D0%BC%D0%B5%D1%82%D0%B0%D0%BB",
                UseShellExecute = true
            });
        }
    }
